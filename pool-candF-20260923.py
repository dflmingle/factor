...
class CandFPoolFactor(Factor):
    """Swap test: SIZE + H03 + T10-ADD-BM + growth_revenue + BM_ILLIQ.

    This is the three-window search's first-round winner: 替换C with BM_SIZE
    replaced by revenue growth, so growth_revenue's contribution is isolated by
    a single-seat change.
    """
