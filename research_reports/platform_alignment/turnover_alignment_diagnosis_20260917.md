...
输入：`/data/games/factor_/quantlab/.quantlab/cache/research/cn_equity/reports/all_factor_compare_full_a_label1_financialfix2_tieproxy1_pythonindex1_turnoverdiag1/all_factor_local_compare.json`。完整逐条表：`/data/games/factor_/research_reports/platform_alignment/turnover_alignment_diagnosis_20260917.csv`。
...
换手状态： `comparable`=157, `platform_high_local_low`=1, `platform_turnover_over_100`=1, `unavailable`=1
...
| net-dd-multiobjective-20260916-diversified-candidates.report:F-NET-D02 | `platform_high_local_low` | +85.61pp | +9.72pp | -16.17pp | platform_high_local_low;large_turnover_gap |
...
| net-dd-multiobjective-20260916-diversified-candidates.report:F-NET-D02 | `paper_composite_nomcap` | +9.72pp | -16.17pp | 90.35% / 4.74% | 0/20 |
...
| 记录 | 公式 | 原因 |
|---|---|---|
| alphaprobe-gfn-new-20260916-candidates.report:F-GFN-N01-20260916 | `AMOUNT / VOLUME / HIGH` | market formula needs high/low/amount; use the rich market cache or the explicit local proxy |
| alphaprobe-gfn-new-20260916-candidates.report:F-GFN-N02-20260916 | `BOOK_TO_MARKET_RATIO_LF / OPER_MAIN_PROFIT_TTM` | book_to_market_ratio_lf is not mapped in the local financial cache |
