...
`four_core` 是预先固定的 PC1-PC4 核心组合；`five_core_*` 只是在该核心上各加入一个第 5-7 方向，用来观察弱方向是否改善，而不是权重搜索。
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | four_core | 4 | 241 | 0.0886 | 0.0482 | 17.36% | 14.14% | 4.28% | 13.08% | 0.9089 | 33.55% | 73.33% |
| 5 | single_book_to_market_lf_plus_impact | 1 | 241 | 0.0615 | 0.0341 | 14.60% | 5.75% | 1.74% | 12.86% | 0.8827 | 33.18% | 66.67% |
| 5 | five_core_residual | 5 | 241 | 0.0934 | 0.0472 | 16.69% | 12.69% | 3.84% | 12.85% | 0.9490 | 31.09% | 73.33% |
| 5 | five_core_growth | 5 | 241 | 0.0823 | 0.0451 | 16.81% | 13.47% | 4.07% | 12.73% | 0.8922 | 34.04% | 75.00% |
...
| 5 | five_core_quality | 5 | 241 | 0.0958 | 0.0498 | 17.03% | 18.41% | 5.57% | 11.46% | 0.8616 | 33.79% | 73.33% |
...
| 10 | four_core | 4 | 120 | 0.1068 | 0.0626 | 16.91% | 23.20% | 3.51% | 13.41% | 0.9311 | 27.34% | 73.33% |
| 10 | single_book_to_market_lf_plus_impact | 1 | 120 | 0.0759 | 0.0453 | 14.22% | 8.96% | 1.35% | 12.86% | 0.8917 | 27.96% | 66.67% |
| 10 | five_core_growth | 5 | 120 | 0.0993 | 0.0582 | 15.93% | 22.28% | 3.37% | 12.56% | 0.9010 | 28.15% | 71.67% |
| 10 | seven_without_residual_volatility | 6 | 120 | 0.1094 | 0.0615 | 16.65% | 27.22% | 4.12% | 12.53% | 0.9092 | 26.84% | 73.33% |
| 10 | five_core_residual | 5 | 120 | 0.1121 | 0.0621 | 15.71% | 21.03% | 3.18% | 12.53% | 0.9496 | 25.21% | 71.67% |
...
| 10 | five_core_quality | 5 | 120 | 0.1152 | 0.0650 | 15.93% | 28.27% | 4.27% | 11.66% | 0.8862 | 25.72% | 76.67% |
...
详细逐期持仓端统计见：
`research_reports/platform_alignment/pca-seven-class-combination-20260917-expanded.periods.csv`

机器可读汇总见：
`research_reports/platform_alignment/pca-seven-class-combination-20260917-expanded.json` 和 `research_reports/platform_alignment/pca-seven-class-combination-20260917-expanded.csv`
