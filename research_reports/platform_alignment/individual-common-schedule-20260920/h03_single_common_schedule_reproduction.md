# Promising local combination: H03 three-window reproduction
...
`H03` is an equal-weight local combination selected by an offline exhaustive search from saved positive single-mechanism representatives. It is a research candidate, not a platform result.
...
|---|---:|---:|---:|---:|---:|---:|
| `formal_5y` | 120 | 0.0629 | 16.70% | 15.34% | 8.99% | 1.36% |
| `recent_2026` | 15 | 0.0637 | 18.32% | 16.97% | 8.91% | 1.35% |
| `since_2026_06_01` | 5 | 0.1279 | 45.67% | 44.24% | 9.51% | 1.44% |
