# Promising local combination: RESVOL three-window reproduction
...
`RESVOL` is an equal-weight local combination selected by an offline exhaustive search from saved positive single-mechanism representatives. It is a research candidate, not a platform result.
...
|---|---:|---:|---:|---:|---:|---:|
| `formal_5y` | 120 | 0.0702 | 4.36% | 3.31% | 7.01% | 1.06% |
| `recent_2026` | 15 | 0.0721 | 6.72% | 5.76% | 6.36% | 0.96% |
| `since_2026_06_01` | 5 | 0.1315 | 31.55% | 30.77% | 5.17% | 0.78% |
